...
void persistent_pools_init(struct PoolSplit *a) {
    ...
    sound_alloc_pool_init(&gUnusedLoadedPool.persistent.pool, sound_alloc_uninitialized(&gPersistentCommonPool, a->wantUnused),
                  a->wantUnused);
...
void temporary_pools_init(struct PoolSplit *a) {
    ...
    sound_alloc_pool_init(&gUnusedLoadedPool.temporary.pool, sound_alloc_uninitialized(&gTemporaryCommonPool, a->wantUnused),
                  a->wantUnused);
