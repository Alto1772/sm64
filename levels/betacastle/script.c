...
#include "levels/betacastle/header.h"

const LevelScript level_betacastle_entry[] = {
    INIT_LEVEL(),

    LOAD_MIO0(0x07, _betacastle_segment_7SegmentRomStart, _betacastle_segment_7SegmentRomEnd),
    ...
    AREA(1, geo_betacastle),
        ...
        TERRAIN(betacastle_seg7_collision_level),
    END_AREA(),
